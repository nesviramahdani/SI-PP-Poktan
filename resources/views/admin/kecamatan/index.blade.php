...
@endpush
@section('content_title', 'Data Kecamatan')
@section('content')
<div class="row">
  <div class="col-12">
    <div class="card">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="id_kecamatan_create">ID Kecamatan:</label>
            <input required type="" name="id_kecamatan" id="id_kecamatan_create" class="form-control">
          </div>
          <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="id_kecamatan_edit">ID Kecamatan:</label>
            <input required type="hidden" readonly="" name="id" id="id_edit" class="form-control">
            <input type="" name="id_kecamatan" readonly id="id_kecamatan_edit" class="form-control">
          </div>
          <div class="form-group">
