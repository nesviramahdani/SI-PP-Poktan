...
@endpush
@section('content_title', 'Data Bantuan')
@section('content')
<div class="row">
  <div class="col-12">
    <div class="card">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input required type="text" name="jenis_bantuan" id="jenis_bantuan_create" class="form-control">
          </div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="id_bantuan_edit">ID Bantuan:</label>
            <input required type="hidden" readonly="" name="id" id="id_edit" class="form-control">
            <input type="text" name="id_bantuan" readonly id="id_bantuan_edit" class="form-control">
          </div>
          <div class="form-group">
            <label for="jenis_bantuan_edit">Jenis Bantuan:</label>
            <input type="text" name="jenis_bantuan" id="jenis_bantuan_edit" class="form-control">
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">CLOSE</button>
