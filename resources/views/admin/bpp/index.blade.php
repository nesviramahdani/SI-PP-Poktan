...
@endpush
@section('content_title', 'Data BPP')
@section('content')
<div class="row">
  <div class="col-12">
    <div class="card">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="id_bpp_create">ID BPP:</label>
            <input required type="" name="id_bpp" id="id_bpp_create" class="form-control">
          </div>
          <div class="form-group">
            <label for="nama_bpp_create">Nama BPP:</label>
            <input required type="" name="nama_bpp" id="nama_bpp_create" class="form-control">
          </div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="id_bpp_edit">ID BPP:</label>
            <input required type="hidden" readonly="" name="id" id="id_edit" class="form-control">
            <input type="" name="id_bpp" readonly id="id_bpp_edit" class="form-control">
          </div>
          <div class="form-group">
            <label for="nama_bpp_edit">Nama BPP:</label>
            <input type="" name="nama_bpp" id="nama_bpp_edit" class="form-control">
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">CLOSE</button>
