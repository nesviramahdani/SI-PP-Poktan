...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="col-3">
        <a href="" onclick= "this.href='/penyuluh/kegiatan-cetakKegiatan/' + document.getElementById('tanggal_mulai').value + '/'+ document.getElementById('tanggal_selesai').value" target="_blank"   class="btn btn-danger btn-sm"><i class="fas fa-print fa-fw"></i> PRINT</a>
      </div>
    </div>
      </form>
      </div>
        ...
        <table id="dataTable2" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('kegiatan.edit', $p->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                <form action="{{ route('kegiatan.destroy', $p->id) }}" method="POST" style="display: inline">
