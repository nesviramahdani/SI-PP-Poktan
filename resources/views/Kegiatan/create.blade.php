      ...
      <form action="{{ route('kegiatan.store') }}" method="post">
        ...
        <div class="form-group mb-3">
          ...
          <div class="input-group input-group-alternative">
            <input class="form-control" placeholder="Nama Kegiatan" type="text" name="nama_kegiatan" required>
          </div>
        </div>
        <div class="form-group mb-3">
            <label>Tanggal Kegiatan:</label>
            <div class="input-group input-group-alternative">
              <input class="form-control" placeholder="Tanggal Kegiatan" type="date" name="tanggal_kegiatan" required>
            </div>
          </div>
          <div class="form-group mb-3">
          ...
          <div class="form-group mb-3">
            <label>Lokasi:</label>
            <div class="input-group input-group-alternative">
                <textarea name="lokasi" class="form-control" placeholder="Lokasi" required></textarea>
            </div>
          </div>
