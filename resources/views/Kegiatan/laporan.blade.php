		...
		<div class="card">
			...
			<div class="card-body">
				<form method="POST" action="#">
					...
					<div class="form-group">
						<a href="" onclick= "this.href='/penyuluh/kegiatan-cetaklaporan/' + document.getElementById('tanggal_mulai').value + '/'+ document.getElementById('tanggal_selesai').value" target="_blank"   class="btn btn-danger btn-sm"><i class="fas fa-print fa-fw"></i> PRINT</a>
